...
public class ForecastFragment extends Fragment {
    ...
    // declare it here so AsyncTask (FetchWeatherTask) and onCreateView can access/modify in runtime too
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        // to make this fragment handle menu events
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        arrayAdapter = new ArrayAdapter<String>(getActivity(), R.layout.list_item_forecast, R.id.list_item_forecaset_textview, arrayList);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            // to hold final formated forecast info
            String[] forecastStrings = new String[0];
